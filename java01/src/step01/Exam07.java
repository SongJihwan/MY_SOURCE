...
public class Exam07{
  public static void main(String[] args){
    ...
    System.out.println(20L);         //8byte (이 표현을 많이 사용함)
    System.out.println(20l);         //8byte
    System.out.println(3.141592);    //8byte
    System.out.println(3.141592F);   //4byte
    System.out.println(3.141592f);   //4byte (이 표현을 많이 사용함)
