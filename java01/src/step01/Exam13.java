...
public class Exam13{
  public static void main(String[] args){
    ...
    System.out.println((char)0x0059);
    System.out.println((char)0xAC00);
    System.out.println((char)0xAC01);


    //자바에서 제공하는 특수한 연산자 ''
    //=> ''안에 있는 문자에 대해 유니코드 값을 리턴함
    System.out.println('A');
    System.out.println('a');
    System.out.println('가');

    int a = 'A'; //''연산자는 A문자에 대한 유니코드 값을 리턴함
    int b = 'a'; //''연산자는 B문자에 대한 유니코드 값을 리턴함
    int c = '가'; //''연산자는 C문자에 대한 유니코드 값을 리턴함
...
2) ISO-8859-1(8bit) International Standard for Organize
- ASCII + 유럽문자
...
7) UTF-8(1 ~ 4바이트) Unicode Transform Format
- 유니코드 문자를 재정의 함.
