...
public class MemberDao {
  ...
  public List<Member> checkUser(String email) throws Exception {
    SqlSession sqlSession = sqlSessionFactory.openSession();

    try {
      return sqlSession.selectList("MemberDao.checkUser", email);
    } finally {
      sqlSession.close();
    }
  }
  ...
  public boolean isUser(String email, String pwd) {
    SqlSession sqlSession = sqlSessionFactory.openSession();
